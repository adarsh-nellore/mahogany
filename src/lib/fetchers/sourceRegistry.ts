...
export const REGISTRY: SourceDef[] = [
  ...
  { source_id: "us_fda_device_safety_rss",    label: "FDA Device Safety RSS",            url: "https://www.fda.gov/about-fda/contact-fda/stay-informed/rss-feeds/medical-devices/rss.xml",       authority: "FDA",          region_hint: "US", domain_hint: "devices",  tier: "rss", priority: 1 },
  ...
  { source_id: "us_fda_cber_rss",             label: "FDA CBER (Biologics) RSS",         url: "https://www.fda.gov/about-fda/contact-fda/stay-informed/rss-feeds/vaccines-blood-biologics/rss.xml", authority: "FDA CBER", region_hint: "US", domain_hint: "pharma",   tier: "rss", priority: 1 },
  { source_id: "us_fda_warning_letters_rss",  label: "FDA Warning Letters RSS",          url: "https://www.fda.gov/about-fda/contact-fda/stay-informed/rss-feeds/warning-letters/rss.xml",       authority: "FDA",          region_hint: "US", domain_hint: null,       tier: "rss", priority: 1 },
  { source_id: "us_fda_guidance_doc_rss",     label: "FDA Guidance Documents RSS",       url: "https://www.fda.gov/about-fda/contact-fda/stay-informed/rss-feeds/guidance/rss.xml",              authority: "FDA",          region_hint: "US", domain_hint: null,       tier: "rss", priority: 1 },
  ...
  { source_id: "us_fda_outbreaks_rss",        label: "FDA Outbreaks RSS",                url: "https://www.fda.gov/about-fda/contact-fda/stay-informed/rss-feeds/outbreaks/rss.xml",             authority: "FDA",          region_hint: "US", domain_hint: null,       tier: "rss", priority: 1 },
